...
LemSwe2=ggplot(wordsLemSwe2,aes(reorder(Lem,Freq),Freq)) + 
  geom_bar(stat = "identity",fill="#440154FF",colour="gray30") +
  scale_fill_viridis("Lemma",discrete = TRUE, option = "D") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  ggtitle("The most frequently used lemmata in Turdish") +
  xlab("Words") +
  ylab("Frequency") +
  coord_flip() +
  theme_minimal()
